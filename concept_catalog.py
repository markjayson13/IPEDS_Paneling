...
CONCEPTS: "OrderedDict[str, dict[str, object]]" = OrderedDict(
    {
        # =====================================================
        # Institutional Characteristics (IC) — identifiers/codes
        # =====================================================
        "ic_sector": {
            "target_var": "ic_sector",
            "concept": "Sector (control × level)",
            "units": "code",
            "survey": "InstitutionalCharacteristics",
            "period_type": "static",
            "label_regex": [r"^sector$|^sector of institution$"],
            "exclude_regex": [r"name|address|city|zip|county|identifier"],
            "notes": "Numeric sector code.",
            "transform": "identity",
        },
        "ic_control": {
        ...
        "ic_level": {
            "target_var": "ic_level",
            "concept": "Institution level",
            "units": "code",
            "survey": "InstitutionalCharacteristics",
            "period_type": "static",
            "label_regex": [r"^institution level$|^level of institution$|^level$"],
            "exclude_regex": [],
            "transform": "identity",
        },
        "ic_highest_degree": {
            "target_var": "ic_highest_degree",
            "concept": "Highest degree offered",
            "units": "code",
            "survey": "InstitutionalCharacteristics",
            "period_type": "static",
            "label_regex": [r"^highest degree offered$|^highest degree$"],
            "exclude_regex": [],
            "transform": "identity",
        },
        "ic_calendar_system": {
        ...
        "ic_title_iv": {
            "target_var": "ic_title_iv",
            "concept": "Title IV participant indicator",
            "units": "code",
            "survey": "InstitutionalCharacteristics",
            "period_type": "static",
            "label_regex": [r"^title iv (?:eligibility|eligible|participant)$|^title iv eligible$"],
            "exclude_regex": [],
            "notes": "Binary or small-code indicator, varies by year.",
            "transform": "identity",
        },
        "ic_open_admissions": {
        ...
        "ic_urbanicity": {
            ...
            "concept": "Degree of urbanization",
            "units": "code",
            "survey": "InstitutionalCharacteristics",
            "period_type": "static",
            "label_regex": [r"^degree of urbanization$|^urbanization$|^urbanicity$"],
            "exclude_regex": [],
            "transform": "identity",
        },
        # -------------------------
