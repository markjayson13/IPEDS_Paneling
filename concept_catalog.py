...
``dictionary_lake.parquet`` generated by ``01_ingest_dictionaries.py``. That
lake now uses the short IPEDS ``varName`` (the same codes used in the raw CSVs),
so fields like ``varname_exact`` and ``varname_regex`` in this catalog map
directly to the short variable names present in the newly downloaded data.
When ``download_ipeds.py`` refreshes yearly manifests, ``harmonize_new`` can
combine those manifests with the concept catalog to locate and parse the
correct survey files without editing legacy modules.
"""
...
# IC covers AY costs through 2023; CST takes over in 2024+ Cost forms.
GLOBAL_EXCLUDE = re.compile(r"^(unitid|instnm|opeid.*|^id$)", re.I)

ANP_REQUIRED_KEYWORDS = ["net price", "title iv"]
ANP_EXCLUDE_REGEX = [
    r"average amount",
    r"\bgrant(?:s)?\b",
    r"\bscholarship(?:s)?\b",
    r"\bpercent(?:age)?\b",
    r"\bnumber\b|\bcount\b|\brate\b",
    r"\bawarded\b|\breceived\b",
    r"\bnon[- ]title iv\b",
]
...
CONCEPTS: "OrderedDict[str, dict[str, object]]" = OrderedDict(
    {
        ...
        "forms": ["HD","ICHD","IC","INSTITUTIONALCHARACTERISTICS","INSTITUTIONAL CHARACTERISTICS"],
            ...
            "exclude_regex": [],
            "varname_exact": "opeflag",
            "code_regex": r"(?i)^OPEFLAG$",
        },
        "dir_opeid": {
        ...
        "notes": "Alias; avoid double-penalizing",
        },
        "dir_county_name": {
        ...
        "survey": "InstitutionalCharacteristics",
        "period_type": "AY",
        "forms": ["HD", "IC", "INSTITUTIONALCHARACTERISTICS","INSTITUTIONAL CHARACTERISTICS", "ICHD"],
        "form_aliases": ["IC"],
        ...
        "ic_open_public": {
            ...
            "exclude_regex": [],
            "varname_exact": "openpubl",
        },
        # Status code (ACT) — canonical status of institution
        "ic_status_of_institution": {
            "target_var": "ic_status_of_institution",
            "concept": "Status of institution (ACT status code)",
            "units": "code",
            "survey": "InstitutionalCharacteristics",
            "period_type": "AY",
            "forms": ["HD", "IC", "ICHD", "INSTITUTIONALCHARACTERISTICS","INSTITUTIONAL CHARACTERISTICS"],
            "label_regex": [
                r"^status of institution$",
                r"^active\\s*-\\s*institution active$",
                r"^new active.*$",
                r"^restore active.*$",
                r"^combined with other institution$",
                r"^delete out of business$",
            ],
            "exclude_regex": [r"act composite|admissions|test score|sat|percentile"],
            "varname_exact": "act",
        },
        # Boolean active flag (to be derived later from ACT code)
        "ic_active_in_year": {
            "target_var": "ic_active_in_year",
            "concept": "Institution is active in current year (derived from ACT code)",
            "units": "code",
            "survey": "InstitutionalCharacteristics",
            "period_type": "AY",
            "expected_available": False,
            "notes": "Derive later from ic_status_of_institution/ACT codebook.",
        },
        ...
        "min_year": 2004,
        "max_year": 2023,
        "forms": ["ICAY", "IC", "ICHD", "INSTITUTIONALCHARACTERISTICS","INSTITUTIONAL CHARACTERISTICS", "DRVIC", "DRVAL"],
        "label_regex": [
        ...
        "ic_coa_on_campus": {
            ...
            "survey": "InstitutionalCharacteristics",
            "period_type": "AY",
        "forms": ["ICAY","IC","ICHD","HD","INSTITUTIONALCHARACTERISTICS","INSTITUTIONAL CHARACTERISTICS"],
        "min_year": 2004,
        "max_year": 2023,
    ...
    "cst_tuition_ft_gr_in_district": {
        ...
        "forms": ["CST", "COST"],
        "min_year": 2024,
        "varname_exact": "tuition5",
        "label_regex": [
            r"^graduate students.*in[- ]district.*full[- ]?time.*tuition$",
            r"^tuition.*graduate.*full[- ]?time.*in[- ]district$",
        ],
        "exclude_regex": [
            r"per credit hour",
            r"part[- ]?time",
    ...
    "cst_fees_ft_gr_in_district": {
        "target_var": "cst_fees_ft_gr_in_district",
        "concept": "Graduate required fees, full-time, in-district (excl. doctoral-professional practice)",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        ...
        "varname_exact": "fee5",
        "label_regex": [
            r"^graduate students.*in[- ]district.*full[- ]?time.*required fees$",
            r"^required fees.*graduate.*full[- ]?time.*in[- ]district$",
        ],
        "exclude_regex": [
            r"per credit hour",
            r"part[- ]?time",
    ...
    "cst_tuition_ft_gr_in_state": {
        "target_var": "cst_tuition_ft_gr_in_state",
        "concept": "Graduate tuition, full-time, in-state (excl. doctoral-professional practice)",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        "min_year": 2024,
        "varname_exact": "tuition6",
        "label_regex": [
            r"^graduate students.*in[- ]state.*full[- ]?time.*tuition$",
            r"^tuition.*graduate.*full[- ]?time.*in[- ]state$",
        ],
        "exclude_regex": [
            r"per credit hour",
            r"part[- ]?time",
    ...
    "cst_fees_ft_gr_in_state": {
        "target_var": "cst_fees_ft_gr_in_state",
        "concept": "Graduate required fees, full-time, in-state (excl. doctoral-professional practice)",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        ...
        "varname_exact": "fee6",
        "label_regex": [
            r"^graduate students.*in[- ]state.*full[- ]?time.*required fees$",
            r"^required fees.*graduate.*full[- ]?time.*in[- ]state$",
        ],
        "exclude_regex": [
            r"per credit hour",
            r"part[- ]?time",
    ...
    "cst_tuition_ft_gr_out_state": {
        "target_var": "cst_tuition_ft_gr_out_state",
        "concept": "Graduate tuition, full-time, out-of-state (excl. doctoral-professional practice)",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        "min_year": 2024,
        "varname_exact": "tuition7",
        "label_regex": [
            r"^graduate students.*out[- ]of[- ]state.*full[- ]?time.*tuition$",
            r"^tuition.*graduate.*full[- ]?time.*out[- ]of[- ]state$",
        ],
        "exclude_regex": [
            r"per credit hour",
            r"part[- ]?time",
    ...
    "cst_fees_ft_gr_out_state": {
        "target_var": "cst_fees_ft_gr_out_state",
        "concept": "Graduate required fees, full-time, out-of-state (excl. doctoral-professional practice)",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        ...
        "varname_exact": "fee7",
        "label_regex": [
            r"^graduate students.*out[- ]of[- ]state.*full[- ]?time.*required fees$",
            r"^required fees.*graduate.*full[- ]?time.*out[- ]of[- ]state$",
        ],
        "exclude_regex": [
            r"per credit hour",
            r"part[- ]?time",
    ...
    "cst_coa_total_on_campus": {
        "target_var": "cst_coa_total_on_campus",
        "concept": "COA total, FTFT undergraduates, on-campus",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        ...
        "varname_exact": "roomamt",
        "label_regex": [
            r"^cost of attendance.*on[- ]campus.*total$",
            r"^on[- ]campus.*cost of attendance.*total$",
        ],
        "exclude_regex": [],
    },
    "cst_coa_total_off_campus_not_with_family": {
        "target_var": "cst_coa_total_off_campus_not_with_family",
        "concept": "COA total, FTFT undergraduates, off-campus not with family",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        ...
        "varname_exact": "boardamt",
        "label_regex": [
            r"^cost of attendance.*off[- ]campus.*(not with family|without family).*total$",
            r"^off[- ]campus.*(not with family|without family).*cost of attendance.*total$",
        ],
        "exclude_regex": [],
    },
    "cst_coa_total_off_campus_with_family": {
        "target_var": "cst_coa_total_off_campus_with_family",
        "concept": "COA total, FTFT undergraduates, off-campus with family",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        ...
        "varname_exact": "rmbrdamt",
        "label_regex": [
            r"^cost of attendance.*off[- ]campus.*with family.*total$",
            r"^off[- ]campus.*with family.*cost of attendance.*total$",
        ],
        "exclude_regex": [],
    },
    "cst_coa_books_supplies": {
        "target_var": "cst_coa_books_supplies",
        "concept": "Books and supplies (COA input)",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        "min_year": 2024,
        "varname_exact": "booksupp",
        "label_regex": [
    ...
    "cst_coa_food_housing_on_campus": {
        ...
        "concept": "Food and housing, on-campus (COA input)",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        ...
        "varname_exact": "rmbrdamt",
        "label_regex": [
            r"^food and housing.*on[- ]campus$",
            r"^on[- ]campus.*food and housing$",
            r"^room and board.*on[- ]campus$",
        ],
        "exclude_regex": [],
    },
    "cst_coa_food_housing_off_campus_not_with_family": {
        "target_var": "cst_coa_food_housing_off_campus_not_with_family",
        "concept": "Food and housing, off-campus not with family (COA input)",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        ...
        "varname_exact": "rmbrdamt",
        "label_regex": [
            r"^food and housing.*off[- ]campus.*(not with family|without family)$",
            r"^off[- ]campus.*(not with family|without family).*food and housing$",
            r"^room and board.*off[- ]campus.*not with family$",
        ],
        "exclude_regex": [],
    },
    "cst_coa_food_housing_off_campus_with_family": {
        "target_var": "cst_coa_food_housing_off_campus_with_family",
        "concept": "Food and housing, off-campus with family (COA input)",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        ...
        "varname_exact": "rmbrdamt",
        "label_regex": [
            r"^food and housing.*off[- ]campus.*with family$",
            r"^off[- ]campus.*with family.*food and housing$",
            r"^room and board.*off[- ]campus.*with family$",
        ],
        "exclude_regex": [],
    },
    "cst_coa_other_expenses_on_campus": {
        "target_var": "cst_coa_other_expenses_on_campus",
        "concept": "Other expenses, on-campus (COA input)",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        ...
        "varname_exact": "rmbrdamt",
        "label_regex": [
            r"^other expenses.*on[- ]campus$",
            r"^on[- ]campus.*other expenses$",
        ],
        "exclude_regex": [],
    },
    "cst_coa_other_expenses_off_campus_not_with_family": {
        "target_var": "cst_coa_other_expenses_off_campus_not_with_family",
        "concept": "Other expenses, off-campus not with family (COA input)",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST", "COST"],
        ...
        "varname_exact": "rmbrdamt",
        "label_regex": [
            r"^other expenses.*off[- ]campus.*(not with family|without family)$",
            r"^off[- ]campus.*(not with family|without family).*other expenses$",
        ],
        "exclude_regex": [],
    },
    "cst_coa_other_expenses_off_campus_with_family": {
        "target_var": "cst_coa_other_expenses_off_campus_with_family",
        "concept": "Other expenses, off-campus with family (COA input)",
        "units": "USD",
        "survey": "Cost",
        "period_type": "AY",
        "forms": ["CST"],
        "min_year": 2024,
        "label_regex": [
            r"^other expenses.*off[- ]campus.*with family$",
        ...
        "ic_tuition_charge_varies": {
            ...
            "varname_regex": r"(?i)^(TUITVARY|TUITVRY)$",
        },
        "ic_alt_tuition_any": {
        ...
        "ic_med_school_flag": {
            ...
            "varname_regex": r"(?i)^(MEDICAL|MEDSCH)$",
            "transform": "identity",
        },
        # =========================
        # Finance (FY) — Revenues
        ...
        "fin_total_rev_invest_return": {
            ...
            "survey": "Finance",
            "period_type": "FY",
            "forms": ["FIN", "F1A", "F2A", "F3A", "F1", "F2", "F3"],
            "label_regex": [
            ...
            "varname_regex": r"(?i)^(F1B19|F2C10|F3C09|F1AF09)$",
        },
        "fin_tuition_fees_net": {
            ...
            r"\bexpenses?\b|\bdeductions?\b|\boperations?\b|\bmaintenance\b|\bfringe\b",
        ],
            "notes": "Net revenue line; excludes contra-revenue allowances.",
            "min_accept_score": 3.0,
            "varname_regex": r"(?i)^(F1B01|F2C08|F3C06)$",
        ...
        "varname_regex": r"(?i)^(F1B02|F2C02|F3C02)$",
    },
        ...
        "varname_regex": r"(?i)^(F1B03|F2C03|F3C03)$",
    },
        ...
        "varname_regex": r"(?i)^(F1B04|F2C04|F3C04)$",
    },
        ...
        "varname_regex": r"(?i)^(F1B05|F2C05|F3C05)$",
    },
        ...
        "varname_regex": r"(?i)^(F1B06|F2C06|F3C06)$",
    },
        "fin_auxiliary_rev": {
        ...
        "exclude_regex": [r"expenses?"],
        "varname_regex": r"(?i)^(F1B07|F2C07|F3C07)$",
    },
        "fin_hospital_rev": {
        ...
        "exclude_regex": [r"expenses?"],
        "varname_regex": r"(?i)^(F1B08|F2C09|F3C08)$",
    },
        ...
        "notes": "Flow; distinct from endowment asset balances.",
            "varname_regex": r"(?i)^(F1B18|F1B19|F2C10|F3C09)$",
        },
        ...
        "varname_regex": r"(?i)^(F1D01|F2D02|F3D02)$",
    },
        "fin_research_exp": {
        ...
        "exclude_regex": [r"revenue"],
        "varname_regex": r"(?i)^(F1D02|F2D03|F3D03)$",
    },
        ...
        "exclude_regex": [r"revenue"],
        "varname_regex": r"(?i)^(F1D03|F2D04|F3D04)$",
    },
        ...
        "exclude_regex": [r"revenue"],
        "varname_regex": r"(?i)^(F1D04|F2D05|F3D05)$",
    },
        ...
        "exclude_regex": [r"revenue"],
        "varname_regex": r"(?i)^(F1D05|F2D06|F3D06)$",
    },
        ...
        "exclude_regex": [r"revenue"],
        "varname_regex": r"(?i)^(F1D06|F2D07|F3D07)$",
    },
        "fin_om_plant_exp": {
        ...
        "exclude_regex": [r"revenue"],
        "varname_regex": r"(?i)^(F1D07|F2D08|F3D08)$",
    },
        "fin_scholarships_fellowships_exp": {
            ...
            "varname_regex": r"(?i)^(F1D08|F2D09|F3D09)$",
        ...
        "varname_regex": r"(?i)^(F1D09|F2D12|F3D12)$",
    },
        "fin_interest_exp": {
        ...
        "varname_regex": r"(?i)^(F1D10|F2D13|F3D13)$",
    },
        "fin_total_exp": {
        ...
        "varname_regex": r"(?i)^(F1B19|F2D14|F3D13|F1AF12|F2AF12|F3AF12)$",
    },
        ...
        "exclude_regex": [r"gross|revenue|expense|aid|scholarship|contra|discount"],
        "varname_regex": r"(?i)^(F1E08|F2C08|F3C06|F3D01|F1E13[1-7])$",
        "notes": "Contra-revenue for tuition; do not mix with expense aid lines.",
        "expected_available": False,
    },
        "fin_allowances_aux": {
        ...
        "exclude_regex": [r"gross|revenue|expense|aid|scholarship|contra|discount"],
        "varname_regex": r"(?i)^(F1E09|F2C09|F3C07|F2D12|F3D07|F1E14[1-2]|F1E15[1-2]|F1E16[1-2]|F1E17[1-2])$",
        "expected_available": False,
    },
        ...
        "varname_regex": r"(?i)^(F1D03|F2D03|F3D03|FINRESP)$",
        "expected_available": False,
    },
        "fin_revision_status": {
        ...
        "varname_regex": r"(?i)^(F1D04|F2D04|F3D04|FINREV)$",
        "expected_available": False,
    },
        ...
        "varname_regex": r"(?i)^(F1D05|F2D05|F3D05|FINPCI)$",
        "expected_available": False,
    },
        "fin_parent_unitid": {
        ...
        "varname_regex": r"(?i)^(F1D06|F2D06|F3D06|FINPARENT)$",
        "expected_available": False,
    },
        ...
        "period_type": "AY",
        "forms": ["EF", "EFIA", "EFRACE", "EFRACE2", "FALLENROLLMENT"],
        ...
        "survey": "12MonthEnrollment",
        "period_type": "AY",
        "forms": ["E12", "E1D", "EFFY", "EFIA", "E12A", "E12DIST"],
    ...
    "e12_parent_unitid": {
        ...
        "sat_ebrw_p25": {
            ...
            "varname_regex": r"(?i)^(SATVR25|SATEBR25|SATEBRW25)$",
        },
        "sat_ebrw_p75": {
            ...
            "varname_regex": r"(?i)^(SATVR75|SATEBR75|SATEBRW75)$",
        },
        "sat_math_p25": {
        ...
        "sfa_any_aid_recip_count": {
            ...
            "period_type": "AY",
            "forms": ["SFA", "SFAV", "SFAUG", "STUDENTFINANCIALAID"],
            "label_regex": [
        ...
        "sfa_federal_grant_amount": {
            ...
            "varname_exact": "fgrnt_a",
            "varname_regex": r"(?i)^(FGRNT_A|FGRNTA|FGRNTAMT)$",
        },
        ...
        "sfa_state_local_grant_amount": {
            ...
            "exclude_regex": [r"average|per[- ]?recipient|number|recipients?"],
            "varname_exact": "sgrnt_a",
            "varname_regex": r"(?i)^(SGRNT_A)$",
        },
        ...
        "forms": ["SFA", "SFAV", "SFAUG", "STUDENTFINANCIALAID"],
            ...
            "exclude_regex": [r"average|per[- ]?recipient|number|recipients?"],
            "varname_exact": "igrnt_a",
            "varname_regex": r"(?i)^(IGRNT_A)$",
        },
        ...
        "survey": "SFA",
        "period_type": "AY",
        "forms": ["SFA", "SFAV", "SFAUG", "STUDENTFINANCIALAID", "COST", "CST", "DRVIC", "DRVAL", "Derived"],
        "min_year": 2009,
            "label_regex": [
                r"^average net price.*title iv.*$",
                r"^average net price$",
            ],
            "exclude_regex": ANP_EXCLUDE_REGEX + [r"by income"],
            "requires_keywords": ANP_REQUIRED_KEYWORDS,
            "notes": "Title IV FTFT; SFA 2009–2023. (Add CST coverage separately when needed.)",
            "min_accept_score": 4.0,
            "varname_regex": r"(?i)^(NPIS412|NPIS422|NPIS432)$",
        },
        "anp_0_30": {
            "target_var": "anp_0_30",
        ...
        "min_year": 2009,
            "label_regex": [
                r"average net price.*title iv.*(?:less than\s*30[, ]?0{3}|0\s*(?:to|[-–])\s*30[, ]?0{3}|0[- ]30k)",
                r"average net price.*title iv.*0[, ]?001?.*30[, ]?000",
            ],
            "exclude_regex": ANP_EXCLUDE_REGEX,
            "requires_keywords": ANP_REQUIRED_KEYWORDS,
            "notes": "Title IV band.",
            "transform": "identity",
            "band_min": 0,
            ...
            "open_upper": False,
            "min_accept_score": 4.0,
            "varname_regex": r"(?i)^(NPIS412|NPT412|NPIS411)$",
        },
        "anp_30_48": {
        ...
        "min_year": 2009,
            "label_regex": [
                r"average net price.*title iv.*(?:30[, ]?0{3}\s*(?:to|[-–])\s*48[, ]?0{3}|30[, ]?001\s*(?:to|[-–])\s*48[, ]?0{3})",
            ...
            "open_upper": False,
            "min_accept_score": 4.0,
            "varname_regex": r"(?i)^(NPIS422|NPT422|NPIS421)$",
        },
        "anp_48_75": {
        ...
        "min_year": 2009,
            "label_regex": [
                r"average net price.*title iv.*(?:48[, ]?0{3}\s*(?:to|[-–])\s*75[, ]?0{3}|48[, ]?001\s*(?:to|[-–])\s*75[, ]?0{3})",
            ...
            "open_upper": False,
            "min_accept_score": 4.0,
            "varname_regex": r"(?i)^(NPIS432|NPT432|NPIS431)$",
        },
        "anp_75_110": {
        ...
        "min_year": 2009,
            "label_regex": [
                r"average net price.*title iv.*(?:75[, ]?0{3}\s*(?:to|[-–])\s*110[, ]?0{3}|75[, ]?001\s*(?:to|[-–])\s*110[, ]?0{3})",
            ...
            "open_upper": False,
            "min_accept_score": 4.0,
            "varname_regex": r"(?i)^(NPIS442|NPT442|NPIS441)$",
        },
        "anp_110_plus": {
            ...
            "survey": "SFA",
            "period_type": "AY",
            "forms": ["SFA", "SFAV", "SFAUG", "STUDENTFINANCIALAID", "COST", "CST"],
            "min_year": 2009,
            "label_regex": [
                r"average net price.*title iv.*(?:over|greater than)\s*110[, ]?0{3}",
                r"average net price.*title iv.*(?:110[, ]?001.*or more|110[, ]?001.*and over|110k\+)",
            ],
            "exclude_regex": ANP_EXCLUDE_REGEX,
            "requires_keywords": ANP_REQUIRED_KEYWORDS,
            "notes": "Title IV band.",
            ...
            "open_upper": True,
            "min_accept_score": 4.0,
            "varname_regex": r"(?i)^(NPIS452|NPT452|NPIS451)$",
        },
    }
)
