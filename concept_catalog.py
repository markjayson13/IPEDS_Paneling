...
CONCEPTS: "OrderedDict[str, dict[str, object]]" = OrderedDict(
    ...
    "cst_coa_other_expenses_off_campus_with_family": {
        ...
        "varname_regex": r"(?i)^(F[123]B(09|19|20)|F2D16|F3D09|F2B01|F3B01)$",
    },
        ...
        "varname_regex": r"(?i)^(F1B0?1|F1E08|F2C08|F3C06|F3D01|F2D01[2-4]?)$",
        ...
        "varname_regex": r"(?i)^(F1E02|F2C02|F3C02|F2D05[2-4]?|F3D02B|FGRNT_[AP])$",
    },
        ...
        "varname_regex": r"(?i)^(F2C03|F2D06[2-4]?|F3C03A?|F3D03[AB]?)$",
    },
        ...
        "varname_regex": r"(?i)^(F1E06|F2C04|F2D07[2-4]?|F3C03|F3C05|F2D04|SGRNT_A)$",
    },
        ...
        "varname_regex": r"(?i)^(F2D08[23]?[A]?|F2D16|F3D04)$",
    },
        ...
        "varname_regex": r"(?i)^(F2D0?8|F2D10[2-4]?)$",
    },
        "fin_auxiliary_rev": {
        ...
        "exclude_regex": [r"expenses?"],
        "varname_regex": r"(?i)^(F1B05|F2C09|F2D12[2]?|F3C07|F3D07|F1E09)$",
    },
        "fin_hospital_rev": {
        ...
        "exclude_regex": [r"expenses?"],
        "varname_regex": r"(?i)^(F1B06|F2D13[2]?|F3C05|F1C12[1-5]|F2E09[1-2])$",
    },
        ...
        "varname_regex": r"(?i)^(F1AF09|F2AF09|F3AF09|F2B01|F2D1[0-6][2-4]?|F3B01|F3D09)$",
    },
        ...
        "varname_regex": r"(?i)^(F1C01[1-5]?|F2E01[1-2]?|F3E01[1]?)$",
    },
        "fin_research_exp": {
        ...
        "exclude_regex": [r"revenue"],
        "varname_regex": r"(?i)^(F1C02[1-5]?|F2E02[1-2]?|F3E02[1-2]?)$",
    },
        ...
        "exclude_regex": [r"revenue"],
        "varname_regex": r"(?i)^(F1C03[1-5]?|F2E03[1-2]?|F3E02B[12]?)$",
    },
        ...
        "exclude_regex": [r"revenue"],
        "varname_regex": r"(?i)^(F1C05[1-5]?|F2E04[1-3]?|F3E03A[12]?)$",
    },
        ...
        "exclude_regex": [r"revenue"],
        "varname_regex": r"(?i)^(F1C06[1-7]?|F3E03)$",
    },
        ...
        "exclude_regex": [r"revenue"],
        "varname_regex": r"(?i)^(F1C07[1-5]?|F2E06[1-2]?|F3E03C[12]?)$",
    },
        "fin_om_plant_exp": {
        ...
        "exclude_regex": [r"revenue"],
        "varname_regex": r"(?i)^(F1C0?16|F1C1[123]6|F2E07[1-3]?|F3E04[16]?)$",
    },
        "fin_scholarships_fellowships_exp": {
            ...
            "varname_regex": r"(?i)^(F1C10[1-5]?|F1E0[27]|F2C05)$",
        ...
        "exclude_regex": [r"revenue"],
        "varname_regex": r"(?i)^(F1C12[1-5]|F2E09[1-2]|F3E04[6]?)$",
    },
        ...
        "varname_regex": r"(?i)^(F1A284|F2A1[89]|F2E135|F1C0?14|F1C1[24]4)$",
    },
        "fin_interest_exp": {
        ...
        "varname_regex": r"(?i)^(F1C13[1-7]?|F2E136|F3E07[6]?|F3E04)$",
    },
        "fin_total_exp": {
        ...
        "varname_regex": r"(?i)^(F1AF12|F2AF12|F3AF12|F1C19[1-4]?|F2B02|F3B02|F2E13[1-7])$",
    },
        ...
        "sfa_any_aid_amount": {
            ...
            "varname_regex": r"(?i)(ANYAID|XAIDAMT)$",
        },
        "sfa_federal_grant_amount": {
            ...
            "varname_regex": r"(?i)(FGRNT|FEDGRNT).*A$",
        },
        ...
        "sfa_state_local_grant_amount": {
            ...
            "exclude_regex": [r"average|per[- ]?recipient|number|recipients?"],
            "varname_regex": r"(?i)(STGRNT|LOCGRT).*A$",
        },
        ...
        "sfa_institutional_grant_amount": {
            ...
            "exclude_regex": [r"average|per[- ]?recipient|number|recipients?"],
            "varname_regex": r"(?i)(INSTGR|INSTSCH).*A$",
        },
