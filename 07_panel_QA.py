...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out-dir", default="/Users/markjaysonfarol13/IPEDS_Paneling/Checks/panel_qc", help="QA output directory")
    p.add_argument("--prch-qc-dir", default="/Users/markjaysonfarol13/IPEDS_Paneling/Checks/prch_qc", help="PRCH QC dir (for prch_clean_columns.csv)")
